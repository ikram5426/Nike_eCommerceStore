...
const VideoClips = ({ imgsrc, clip }) => {
  return (
    <div className="relative h-40 lg:h-23 md:h-20 sm:h-19 w-40 lg:w-23 md:w-20 sm:w-22 rounded-xl overflow-hidden group cursor-pointer transition-all duration-300">
      <img
        src={imgsrc}
        alt={imgsrc}
      ...
      />
      <div className=" bg-white blur-effect-theme absolute z-[100] opacity-100 top-0 left-0 right-0 h-8 w-8 md:h-5 md:w-5 flex rounded-full items-center justify-center ml-auto mr-auto mt-[40%] group-hover:opacity-0">
